...
if (isset($_POST['send'])) {
    ...
    $a = mysqli_query($con, "insert into goals(email,title,priority,due,status,created)  values('$email','$title','$priority','$due','$st','$pdate')");
    if ($a) {
        echo "<script>alert('Goal Genrated'); location.replace(document.referrer)</script>";
    }
}
?>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        if ($result = mysqli_query($con, "select * from goals where YEAR(created)=YEAR(NOW())")) {
                                            while ($row = $result->fetch_assoc()) {
                                                $field1name = $row["title"];
                                                $field2name = $row["priority"];
                                                $field3name = $row["due"];
