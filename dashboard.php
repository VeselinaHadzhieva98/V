      ...
      <div class="row">
        <div class="col-md-3 col-vlg-3 col-sm-6">
          <div class="tiles green m-b-10">
            <div class="tiles-body">
              ...
              <!-------------------------------------------->
              <div class="tiles-title ">Tasks </div>
              <div class="widget-stats">
                <div class="wrapper transparent">
                  <?php $ov = mysqli_query($con, "select * from tasks where status!='Done'");
                  $num = mysqli_num_rows($ov);
                  ?>
                  <span class="item-title">All</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $num; ?>" data-animation-duration="700">0</span>
                </div>
              </div>
              ...
              <div class="widget-stats ">
                <div class="wrapper last">
                  ...
                  $tv1 = mysqli_query($con, "select * from tasks where status='In Process'");
                  $num11 = mysqli_num_rows($tv1);
                  ?>



                  <span class="item-title">In Process</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $num11; ?>" data-animation-duration="700">0</span>
                  <?php
        ...
        <div class="col-md-3 col-vlg-3 col-sm-6">
          <div class="tiles blue m-b-10">
            <div class="tiles-body">
              <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
              <div class="tiles-title ">Goals </div>
              <div class="widget-stats">
                <div class="wrapper transparent">
                  <?php $rt = mysqli_query($con, "select * from goals");
              ...
              <div class="widget-stats ">
                <div class="wrapper last">
                  <?php
                  $rt1 = mysqli_query($con, "select * from goals where status='Done'");
                  $rw1 = mysqli_num_rows($rt1); ?>
                  <span class="item-title">Done</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $rw1; ?>" data-animation-duration="700">0</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-3 col-vlg-3 col-sm-6">
          <div class="tiles purple m-b-10">
            <div class="tiles-body">
              <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
              <div class="tiles-title ">Incomes </div>
              <div class="widget-stats">
                <div class="wrapper transparent">
                  <?php
                  ...
                  ?>
                  <span class="item-title">This Month</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $oq ?>" data-animation-duration="700">0</span>
                </div>
              </div>
              <div class="widget-stats">
                <div class="wrapper transparent">
                  ...
                  ?>
                  <span class="item-title">Today</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $oq1; ?>" data-animation-duration="700">0</span>
                </div>
              </div>
              <div class="widget-stats ">
                <div class="wrapper last">
        ...
        <div class="col-md-3 col-vlg-3 col-sm-6">
          <div class="tiles red m-b-10">
            <div class="tiles-body">
              <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
              <div class="tiles-title ">Expenditures </div>
              <div class="widget-stats">
                <div class="wrapper transparent">
                  <?php $vt = mysqli_query($con, "select * from ticket");
                  $ovt = mysqli_num_rows($vt);
                  ?>
                  <span class="item-title">This Month</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $ovt; ?>" data-animation-duration="700">0</span>
                </div>
              </div>
              ...
              <div class="widget-stats ">
                <div class="wrapper last">
                  ...
                  <span class="item-title">Today</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $otv1; ?>" data-animation-duration="700">0</span>
                  <?php
        ...
        <div class="col-sm-8">
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              if ($result = mysqli_query($con, "select * from tasks where status!='Done'")) {
